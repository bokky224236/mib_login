...
final List<Item> catalog = [
  ...
  Item(name: "Hello wednesday!🎀", price: 56, imagePath: "3a.jpg"),
...
final List<Item> catalog2 = [
  ...
  Item(name: "Hello wednesday!🎀",price: 56,imagePath: "เดรสดอกน้ำเงิน.jpg"),
  Item(name: "Hello wednesday!🎀", price: 56,imagePath: "เดรสสั้นดอกไม้.jpg"),
  Item(name: "Hello wednesday!🎀",price: 56,imagePath: "เดรสหมึกชมพู.jpg"),
  Item(name: "Hello wednesday!🎀", price: 56, imagePath: "7.jpg"),
  Item(name: "Hello wednesday!🎀", price: 56, imagePath: "8.jpg"),
  Item(name: "Hello wednesday!🎀", price: 56, imagePath: "9.jpg"),
  Item(name: "Hello wednesday!🎀", price: 56, imagePath: "10.jpg"),
